...
let headerPc = Vue.extend({	
	...
	<div>
		...
		<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner" v-bind:class="[isShowInnerImg ? 'inner_img' : '']">
				<div class="carousel-item active">
					<img style="background-size: center;" src="images/bg/bg-8.jpg" class="d-block w-100" alt="...">
				</div>
				<div class="carousel-item">
					<img style="background-position: center;" src="images/bg/bg-9.jpg" class="d-block w-100" alt="...">
				</div>
				<div class="carousel-item">
					<img style="background-position: center;" src="images/bg/bg-10.jpg" class="d-block w-100" alt="...">
				</div>
			</div>
		...
		<div class="sharing_js_pc">
			<div class="col-12 col-md-12 col-lg-12 js_txt text-center">
	...
	created() {
		...
		var url = window.location.href;
  		...
  		}else if(url.match('miniProgram.html')) {
  			this.showXcxline = true;
  			this.currentPageName = 'miniProgram';
  		}else if(url.match('app.html')) {
  			this.showAPPxline = true;
  			this.currentPageName = 'app';
  		}
	},
	mounted() {
		const that = this;
